...
export default {
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "D:\\spec-driven-dev\\ai-native\\sidebars.js",
          "routeBasePath": "docs"
        },
        "blog": {
        ...
        "theme": {
          "customCss": "D:\\spec-driven-dev\\ai-native\\src\\css\\custom.css"
        }
      }
    ]
  ],
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Your Organization, Inc. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
