...
async def ask_question(request: AskRequest):
    ...
    Updated: User context is now optional to allow unauthenticated access.
    ...
    - Content questions: Uses full RAG pipeline with optional personalization

    Personalization affects TONE ONLY when user_profile provided, not factual content.
    RAG grounding is preserved - all facts come from retrieved context.
    """
    # User context is now optional - chatbot works for both authenticated and unauthenticated users
